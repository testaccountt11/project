  ...
  import { FaMapMarkerAlt, FaPhone, FaEnvelope, FaUsers, FaLightbulb, FaRocket } from 'react-icons/fa';
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600">Empowering students to reach their full potential</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-gray-700">
              We are dedicated to connecting students with valuable opportunities in internships,
              competitions, courses, and mentorship programs. Our platform serves as a bridge
              between ambitious students and their future careers.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700">
              To create a comprehensive ecosystem where students can discover, learn, and grow
              through various educational and professional development opportunities.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700">
              Helping thousands of students achieve their dreams through personalized guidance
              and access to life-changing opportunities.
            </p>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <p className="text-gray-700">123 Education Street, New York, NY 10001</p>
              </div>
              <div className="flex items-center space-x-4">
